...
func (x *GetUserRequest) GetSynopsis() string {
	if x != nil {
		return x.Synopsis
	}
	return ""
...
func (x *GetUserRequest) GetAvatar() string {
	if x != nil {
		return x.Avatar
	}
	return ""
...
func (x *GetUserRequest) GetBackgroundImage() string {
	if x != nil {
...
var file_helloworld_v1_greeter_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2e, 0x76, 0x31, 0x22, 0xbc, 0x01, 0x0a,
	...
	0x08, 0x73, 0x79, 0x6e, 0x6f, 0x70, 0x73, 0x69, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x61, 0x76, 0x61,
	...
	0x67, 0x72, 0x6f, 0x75, 0x6e, 0x64, 0x49, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x11, 0x0a, 0x0f, 0x47,
	...
	0x65, 0x73, 0x74, 0x22, 0x14, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xae, 0x01, 0x0a, 0x07, 0x47, 0x72,
	0x65, 0x65, 0x74, 0x65, 0x72, 0x12, 0x4e, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72,
	0x42, 0x79, 0x49, 0x44, 0x12, 0x1d, 0x2e, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x53, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1c, 0x5a, 0x1a, 0x64, 0x65,
	0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72,
...
var file_helloworld_v1_greeter_proto_goTypes = []interface{}{
	(*GetUserRequest)(nil),     // 0: helloworld.v1.GetUserRequest
	(*GetUserResponse)(nil),    // 1: helloworld.v1.GetUserResponse
	(*CreateUserRequest)(nil),  // 2: helloworld.v1.CreateUserRequest
	(*CreateUserResponse)(nil), // 3: helloworld.v1.CreateUserResponse
}
var file_helloworld_v1_greeter_proto_depIdxs = []int32{
	0, // 0: helloworld.v1.Greeter.GetUserByID:input_type -> helloworld.v1.GetUserRequest
	2, // 1: helloworld.v1.Greeter.CreateUser:input_type -> helloworld.v1.CreateUserRequest
	1, // 2: helloworld.v1.Greeter.GetUserByID:output_type -> helloworld.v1.GetUserResponse
	3, // 3: helloworld.v1.Greeter.CreateUser:output_type -> helloworld.v1.CreateUserResponse
